      ...
      <section id="ecosystem" className="relative py-28 border-t border-slate-800 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <motion.div {...fadeUp} className="mb-14">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white leading-[1.0] tracking-tight mb-4">
              The AfuChat Suite.
              <br />
              <span className="text-slate-600">{projects.length} services. One vision.</span>
            </h2>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm text-slate-500">Built by <span className="font-semibold text-slate-300">AM Kaweesi</span></span>
            </div>
          </motion.div>
